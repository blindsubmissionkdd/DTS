...
flags.DEFINE_string("output_file", 't9', "Output filename to write the yaml file with the results")
flags.DEFINE_float("gpumem", 5000, "GPU memory to let TensorFlow use, in MiB (0 for all, divided among jobs)")
flags.DEFINE_string("match", "wisdm_ar-0-yndaws-85", "String matching to determine which logs/models to process")
